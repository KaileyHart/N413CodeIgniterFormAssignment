<!DOCTYPE html>
    <html>
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#1A385A;">
               <a class="navbar-brand" href="<?=site_url()?>">LIT FORM</a>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li id="litlist_item" class="nav-item">
                        <a id="litlist_link" class="nav-link" href="<?=site_url()?>">The List</a>
                     </li>
...
To test this, we need to add a line in the controller to load the "head"